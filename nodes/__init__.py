...
from .sliced_upscaler import NODE_CLASS_MAPPINGS as SLICED_UPSCALER_NODES
from .sliced_upscaler import NODE_DISPLAY_NAME_MAPPINGS as SLICED_UPSCALER_DISPLAY_NAMES
from .sliced_image_hub import NODE_CLASS_MAPPINGS as SLICED_IMAGE_HUB_NODES
from .sliced_image_hub import NODE_DISPLAY_NAME_MAPPINGS as SLICED_IMAGE_HUB_DISPLAY_NAMES
from .slice_combiner_hub import NODE_CLASS_MAPPINGS as SLICE_COMBINER_HUB_NODES
from .slice_combiner_hub import NODE_DISPLAY_NAME_MAPPINGS as SLICE_COMBINER_HUB_DISPLAY_NAMES
from .sliced_commons import NODE_CLASS_MAPPINGS as SLICED_COMMONS_NODES
from .sliced_commons import NODE_DISPLAY_NAME_MAPPINGS as SLICED_COMMONS_DISPLAY_NAMES
...
NODE_CLASS_MAPPINGS = {
    ...
    **DEPENDENCY_NODES,
    **SLICED_UPSCALER_NODES,
    **SLICED_IMAGE_HUB_NODES,
    **SLICE_COMBINER_HUB_NODES,
    **SLICED_COMMONS_NODES,
}
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    **SLICED_UPSCALER_DISPLAY_NAMES,
    **SLICED_IMAGE_HUB_DISPLAY_NAMES,
    **SLICE_COMBINER_HUB_DISPLAY_NAMES,
    **SLICED_COMMONS_DISPLAY_NAMES,
}
